    ...
    _CARDS = [
        {
            ...
            "annual_fee": 695, "welcome_bonus": "80,000–175,000 MR pts",
            ...
            "not_ideal_for": ["Low spenders (<$10k/yr)", "Those who won't use credits"],
            "benefits": {
                "Travel Credits": [
                    ...
                    {"name": "$200 Hotel Credit", "value": "$200/yr", "fp": True,
                     "notes": "Valid ONLY at Fine Hotels + Resorts or The Hotel Collection via Amex Travel. NOT bookable at hotel.com."},
                    ...
                    {"name": "Centurion Lounge Access", "value": "Unlimited*", "fp": True,
                     "notes": "Guests $50 each unless $75k+ spend on card in prior year. Policy changed 2024."},
                    ...
                    {"name": "Delta SkyClub (when flying Delta)", "value": "10 visits/yr*", "fp": True,
                     "notes": "From Feb 2025: capped at 10 visits/yr unless $75k+ spend on card (unlimited then)."},
                ],
                "Hotel & Lifestyle": [
                ...
                "Dining & Entertainment": [
                    {"name": "$240 Digital Entertainment Credit", "value": "$20/mo", "fp": True,
                     "notes": "Covers Disney+, ESPN+, Hulu, Peacock, NYT, WSJ, SiriusXM, The Atlantic. NOT Netflix."},
        ...
        },
        {
            ...
            "annual_fee": 550, "welcome_bonus": "60,000–75,000 UR pts",
            ...
            "best_for": ["Flexible $300 travel credit", "Primary rental car", "Hyatt transfers", "Cell phone protection"],
            "not_ideal_for": ["Amex lounge seekers", "High Marriott/Hilton spenders"],
            "benefits": {
                "Travel Credits": [
                ...
                "Protections": [
                    ...
                    {"name": "Cell Phone Protection", "value": "$800/claim", "fp": True,
                     "notes": "Up to 2 claims/yr. $50 deductible. Pay monthly bill with card. Added 2024."},
                    {"name": "No Foreign Transaction Fee", "value": "✓", "fp": False, "notes": ""},
                ],
                "Transfer Partners": [
                    ...
                    {"name": "Hotels", "value": "1:1 ratio", "fp": False,
                     "notes": "Hyatt (best value), IHG, Marriott."},
                ],
            },
        },
        {
            ...
            "benefits": {
                "Travel Credits": [
                    ...
                    {"name": "Priority Pass Select", "value": "Unlimited", "fp": False,
                     "notes": "Unlimited visits + 2 guests. Each authorized user gets their own PP membership."},
                    {"name": "Capital One Lounge", "value": "Unlimited", "fp": False,
                     "notes": "C1 Lounges at DFW, DEN, IAD and more. 2 free guests per visit."},
                ],
                "Hotel & Lifestyle": [
        ...
        },
        {
            ...
            "reward_rate": "4x dining (worldwide), 4x US supermarkets (up to $25k/yr), 3x flights, 1x else",
            "points_currency": "Membership Rewards", "cpp_estimate": "1.8–2.1¢",
            "ref_link": "https://www.americanexpress.com/us/credit-cards/card/gold-card/",
            "best_for": ["Best dining earn rate (4x)", "Grocery shoppers (4x)", "MR earners on a budget"],
            ...
            "benefits": {
                ...
                "Dining & Entertainment": [
                    {"name": "$120 Dining Credit", "value": "$10/mo", "fp": True,
                     "notes": "Only at Grubhub, Cheesecake Factory, Goldbelly, Wine.com, Milk Bar, select Shake Shack. NOT all restaurants."},
        ...
        },
        {
            ...
            "best_for": ["Entry-level premium card at $95", "Hyatt transfers", "Primary rental car on budget"],
            "not_ideal_for": ["Frequent lounge visitors", "Those who can justify CSR credits"],
            "benefits": {
                "Travel Credits": [
                    {"name": "$50 Annual Hotel Credit", "value": "$50/yr", "fp": True,
                     "notes": "Hotels booked through Chase Travel only. Resets on card anniversary."},
                    {"name": "No Lounge Access", "value": "✗ None", "fp": False, "notes": ""},
                    {"name": "No Global Entry Credit", "value": "✗ None", "fp": False, "notes": ""},
                ],
                "Dining & Entertainment": [
                    {"name": "10% Anniversary Bonus", "value": "10% of pts earned", "fp": True,
                     "notes": "Chase adds 10% of all points earned in the prior year on each anniversary."},
                ...
                "Transfer Partners": [
                    ...
                    {"name": "Hotels", "value": "1:1 ratio", "fp": False,
                     "notes": "Hyatt (best value), IHG, Marriott. Same as CSR."},
                ],
            },
        },
    ]
...
""", unsafe_allow_html=True)
    ...
    st.markdown(
        "<div class='src-note'>Data verified June 2026 · ⚠ fine print badges highlight gotchas · "
        "Always confirm at issuer site before applying</div>",
        unsafe_allow_html=True,
    )
